...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            <p class="navbar-text"><font color="black"  face="Microsoft YaHei" size="5px">HelloWorld !&nbsp;</font></p>
        </div>
        <div class="col-md-4">
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><font color="black"><strong>主页</strong></font></a>
                    </div>

                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li><a href="#"><font color="black"><strong>关于博主</strong></font><span class="sr-only">(current)</span></a></li>
                        </ul>
                        <form class="navbar-form navbar-right">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="请输入要查询的关键字...">
                            </div>
                            <button type="submit" class="btn btn-default"><font color="black"><strong>搜索</strong></font></button>
                        </form>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="datas">
                        <ul>
                            <c:forEach var="blog" items="${blogCountList}">
                                <li><span><a href="/index.html?releaseDateStr=2016年02月">${blog.releaseDateStr}(${blog.blogCount})</a></span></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="padding-top: 120px">
                <div class="col-md-4">
                    <div>
                        <font color="black" face="Microsoft YaHei"><span style="float:left;">Powered by <a href="#" target="_blank">rui1024</a> V1.0</span></font>
                    </div>
                </div>

                <div class="col-md-12">
                    <div align="center" >
                        <div><font color="black" face="Microsoft YaHei">Copyright © 2019 rui1024.com All Rights Reserved</font></div>
                    </div>
                </div>
            </div>
        </div>
